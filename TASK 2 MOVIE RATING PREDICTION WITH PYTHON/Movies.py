...
with t1:
    ...
    with tabs[2]:
        # Displaying distribution of ratings and its probable density
...
# There are some data which cannot make any impact on the output so we have to drop that data
